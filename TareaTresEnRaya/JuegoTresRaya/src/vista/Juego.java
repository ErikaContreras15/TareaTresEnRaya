...
public class Juego extends javax.swing.JFrame {
    ...
    private void Boton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Boton1ActionPerformed
       if(usarboton[0]==0){
            ...
            if(resultado1==1){
                JOptionPane.showMessageDialog(rootPane, "El ganador es el jugador 1. felicitaciones ");
            }else if(resultado2==1){
                JOptionPane.showMessageDialog(rootPane, "El ganador es  el jugador 2. felicitaciones ");
            }
        }else{
            turn++;
            Boton1.setText("O");
           ...
           JOptionPane.showMessageDialog(rootPane, "!Error_el boton ya se uso anteriormente¡");
       }
    ...
    private void resetearActionPerformed(java.awt.event.ActionEvent evt) {
